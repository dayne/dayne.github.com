...
At this point I've got myself some node fun, with npm to help me install things (like rubygems I guess).  Lets try this new capability out by installing "substack's node-browserify":https://github.com/substack/node-browserify
