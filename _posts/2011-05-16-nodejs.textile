...
I wanted to try out some of "substack's":http://github.com/substack crazy stuff.  Here is my quick start guide (as he instructed me):
...
At this point I've got myself some node fun, with npm to help me install things (like rubygems I guess).  Lets try this new capability out by installing "substack's jquery-browserify":https://github.com/substack/node-browserify
...
*node.js needs @nvm@ (an "rvm":http://rvm.beginrescueend.com equivalent)
