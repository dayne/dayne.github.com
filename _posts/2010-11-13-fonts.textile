...
In the end, Julie and I sat down and looked through a variety of cool, free fonts available from "fontsquirrel's fontface kits":http://www.fontsquirrel.com/fontface and she picked out a replacement for my TypeKit font I was using.   I made a backup of "trying out jekyll":/random/trying_out_jekyll.html to see what I was talking about with the TypeKit applied to the site.
